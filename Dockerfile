...
RUN apt-get -y update && apt-get install -y python-rrdtool python-pygame python-scipy python-twisted python-twisted-web python-pil python-setuptools python-pip git make
